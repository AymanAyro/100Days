...
decision1 = input("You stand in fron of two roads, would you go left or right? (L/R) ")
if decision1 == "L" or "l":
    decision2 = input("At the end of the road you found a lake and across the lake there's a huge golden door, would you swim or wait? (S/W) ")
    if decision2 == "W" or "w":
...
elif decision1 == "R" or 'r':
    print("There was a hole at the end of the road, you fell and died. GAME OVER.")
else:
    print("You stood there taking so long to think what to choose until a crocodile appeared from behind and attacked you, you died. GAME OVER.")
